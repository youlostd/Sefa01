...
{
	COSTUME_BODY,			// [중요!!] ECostumeSubTypes enum value는  종류별로 EArmorSubTypes의 그것과 같아야 함.
	COSTUME_HAIR,			// 이는 코스츔 아이템에 추가 속성을 붙이겠다는 사업부의 요청에 따라서 기존 로직을 활용하기 위함임.
//#ifdef __ACCE_COSTUME__
	COSTUME_ACCE,
//#endif
	COSTUME_WEAPON,
