...
namespace quest
{
	...
	enum
	{
		...
		QUEST_CATCH_FISH,
		QUEST_MINE_ORE,
		QUEST_DUNGEON_COMPLETE,
		QUEST_DROP_QUEST_ITEM,
		QUEST_SEND_SHOUT_EVENT,
		QUEST_ADD_FRIEND_EVENT,
		QUEST_SELL_ITEM_EVENT,
		QUEST_ITEM_USED_EVENT,
#ifdef __DAMAGE_QUEST_TRIGGER__
		QUEST_DAMAGE_EVENT,
#endif
		QUEST_MOUNT_RIDING_EVENT,
		QUEST_COMPLETE_MISSIONBOOKS_EVENT,
		
		// Events for Angels & Demons
		QUEST_COLLECT_YANG_FROM_MOB_EVENT,
		QUEST_CRAFT_GAYA_EVENT,
		QUEST_KILL_ENEMY_FRACTION_EVENT,
		QUEST_SPEND_SOULS_EVENT,
		
		// XMAS Event
		QUEST_XMAS_OPEN_DOOR_EVENT,
		QUEST_XMAS_SANTA_SOCKS_EVENT,

		QUEST_DEAD_EVENT,

#ifdef DUNGEON_REPAIR_TRIGGER
		QUEST_DUNGEON_REPAIR_EVENT,
#endif
