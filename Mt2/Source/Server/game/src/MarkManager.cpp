...
// SERVER
void CGuildMarkManager::GetDiffBlocks(DWORD imgIdx, const ::google::protobuf::RepeatedField<uint32_t>& crc_list, std::map<BYTE, const SGuildMarkBlock*>& mapDiffBlocks)
{
	mapDiffBlocks.clear();

	// Å¬¶óÀÌ¾ðÆ®¿¡¼­ ¼­¹ö¿¡ ¾ø´Â ÀÌ¹ÌÁö¸¦ ¿äÃ»ÇÒ ¼ö´Â ¾ø´Ù.
	...
	if (p)
		p->GetDiffBlocks(crc_list, mapDiffBlocks);
}
