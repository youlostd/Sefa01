...
struct FSkillBreath
{
	...
	FSkillBreath(LPCHARACTER p)
	{
		...
		Set1 = static_cast<EJobs>(random_number(0,3));
		Set2 = static_cast<EJobs>(random_number(0,3));
		gender = static_cast<ESex>(random_number(0,2));
	}
			...
			if (true == ent->IsType(ENTITY_CHARACTER))
			{
				...
				if (true == ch->IsPC() && false == ch->IsDead())
				{
					...
					if (ch->GetJob() == Set1)
					{
						...
						int firstDamagePercent =  random_number(BlueDragon_GetSkillFactor(4, "Skill0", "damage", ptr, "min"), BlueDragon_GetSkillFactor(4, "Skill0", "damage", ptr, "max"));
					...
					if (ch->GetJob() == Set2)
					{
						...
						int secondDamagePercent = random_number(BlueDragon_GetSkillFactor(4, "Skill0", "damage", ptr, "min"), BlueDragon_GetSkillFactor(4, "Skill0", "damage", ptr, "max"));
					...
					if (GET_SEX(ch) == gender)
					{
						...
						int thirdDamagePercent = random_number(BlueDragon_GetSkillFactor(4, "Skill0", "gender", ptr, "min"), BlueDragon_GetSkillFactor(4, "Skill0", "gender", ptr, "max"));
					...
					int dam = random_number(BlueDragon_GetSkillFactor(3, "Skill0", "default_damage", "min"), BlueDragon_GetSkillFactor(3, "Skill0", "default_damage", "max"));
		...
		if (NULL != ent)
		{
			if (true == ent->IsType(ENTITY_CHARACTER))
			{
				...
				if (true == ch->IsPC() && false == ch->IsDead())
				{
					...
					int dam = random_number( BlueDragon_GetSkillFactor(3, "Skill1", "default_damage", "min"), BlueDragon_GetSkillFactor(3, "Skill1", "default_damage", "max") );
					dam += (dam * addPct) / 100;
		...
		if (NULL != ent)
		{
			if (true == ent->IsType(ENTITY_CHARACTER))
			{
				...
				if (true == ch->IsPC() && false == ch->IsDead())
				{
					...
					int sec = random_number(BlueDragon_GetSkillFactor(4, "Skill2", "stun_time", "default", "min"), BlueDragon_GetSkillFactor(4, "Skill2", "stun_time", "default", "max"));
					...
					if (ch->GetJob() == Set1)
					{
						...
						sec += random_number(BlueDragon_GetSkillFactor(4, "Skill2", "stun_time", ptr, "min"), BlueDragon_GetSkillFactor(4, "Skill2", "stun_time", ptr, "max"));
					}
					...
					if (GET_SEX(ch) == gender)
					{
						...
						sec += random_number(BlueDragon_GetSkillFactor(4, "Skill2", "gender", ptr, "min"), BlueDragon_GetSkillFactor(4, "Skill2", "gender", ptr, "max"));
					}

					int addPct = BlueDragon_GetRangeFactor("hp_damage", pAttacker->GetHPPct());

					int dam = random_number( BlueDragon_GetSkillFactor(3, "Skill2", "default_damage", "min"), BlueDragon_GetSkillFactor(3, "Skill2", "default_damage", "max") );
					dam += (dam * addPct) / 100;
					...
					for (int i=0 ; i < 5 ; ++i)
					{
						...
						switch( i )
						{
							...
							case 2:
								...
								break;
							case 3:
								tx = ch->GetX() + vec.x * random_number(1,100);
								ty = ch->GetY() + vec.y * random_number(1,100);
								break;
							case 4:
								tx = ch->GetX() + vec.x * random_number(1,10);
								ty = ch->GetY() + vec.y * random_number(1,10);
								break;
						}
					}
