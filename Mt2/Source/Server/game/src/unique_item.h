...
enum
{
...
#ifdef PROMETA
	UNIQUE_ITEM_CAPE_OF_COURAGE_GOLD = 92225,
#endif
	UNIQUE_ITEM_CAPE_OF_COURAGE_ALL = 93004,
	UNIQUE_ITEM_CAPE_OF_COURAGE_PERMANENT = 90028,
	...
	// ¿ëÈ¥¼® ÃßÃâ È®·üÀ» ³ô¿©ÁÖ´Â ¾ÆÀÌÅÛ
	DRAGON_SOUL_EXTRACTOR_GROUP = 10600,
	// ¿ë½É ÃßÃâÇØÁÖ´Â ¾ÆÀÌÅÛ
	...
	ACCE_ITEM_REMOVE_ABSORBATION = 39046,
#endif

	GUILD_RENAME_ITEM_VNUM = 92943,

	UNIQUE_ITEM_FISH_MIND_1 = 72013,
	UNIQUE_ITEM_FISH_MIND_2 = 72014,
	UNIQUE_ITEM_FISH_MIND_3 = 72015,

#ifdef ENABLE_PERMANENT_POTIONS
	ITEM_AUTO_HP_RECOVERY_PERMANENT = 93274,
	ITEM_AUTO_SP_RECOVERY_PERMANENT = 93275,
#endif
