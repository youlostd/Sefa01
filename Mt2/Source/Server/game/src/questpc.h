	...
	class PC
	{
		public:
			enum 
			{
				...
				QUEST_SEND_COUNTER			= (1 << 4),
				QUEST_SEND_ICON_FILE		= (1 << 5),  // 24ÀÚ ±îÁö
		...
		public:
			...
			int			DeleteFlagsByQuest(const string & questname);
...
#ifdef __QUEST_CATEGORIES__
			void		SetCurrentQuestCategoryID(int value);
#endif
