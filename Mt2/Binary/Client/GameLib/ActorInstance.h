...
class CActorInstance : public IActorInstance, public IFlyTargetableObject
{
	...
	public:
		...
		void SetMoveThroughMonster(bool bCanMoveThroughMonster);
	...
	public:
		...
		void AttachWeapon(DWORD dwItemIndex,DWORD dwParentPartIndex = CRaceData::PART_MAIN, DWORD dwPartIndex = CRaceData::PART_WEAPON, bool useSpecular = true);
		void AttachWeapon(DWORD dwParentPartIndex, DWORD dwPartIndex, CItemData * pItemData, bool useSpecular = true);
	...
	public:
		bool IsLeftHandWeapon(DWORD type) { return __IsLeftHandWeapon(type); }
		bool IsRightHandWeapon(DWORD type) { return __IsRightHandWeapon(type); }
