...
class CMapOutdoor : public CMapBase
{
	...
	public:
		...
		void			SetForceRefreshTree() { m_bForceRefreshTree = true; }
#endif

#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
		void			SetForceGravelHide() { m_bForceGravelHide = true; RefreshGravel(); }
		void			ResetForceGravelHide() { m_bForceGravelHide = false; RefreshGravel(); }
		bool			IsForceGravelHide() const { return m_bForceGravelHide; }

		void			SetForceRefreshGravel() { m_bForceRefreshGravel = true; }
#endif
...
#ifdef ENABLE_TREE_HIDE_SYSTEM
		void			RefreshShownTrees(bool bForce = true);
#endif

#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
		void			RefreshGravel();
		void			RefreshShownGravel(bool bForce = true);
#endif
...
#ifdef ENABLE_TREE_HIDE_SYSTEM
		bool						m_bForceRefreshTree;
#endif

#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
		bool						m_bForceGravelHide;
		bool						m_bForceRefreshGravel;
#endif
	...
	public:
		int GetWaterType() const { return mWaterType; }
		void SetWaterType(int type) { mWaterType = type; }
	private:
		int mWaterType;
};
