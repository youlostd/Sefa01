...
class CArea
{
...
#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
			void ShowManual() { bShowManual = true; }
			void HideManual() { bShowManual = false; }
			bool IsShowManual() const { return bShowManual; }
#endif
		} TAmbienceInstance;
	...
	public:
		...
		void			HideTrees();
		void			ShowTrees(float fRangeLimit = 0.0f);
#endif

#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
		void			HideGravel();
		void			ShowGravel(float fRangeLimit = 0.0f);
#endif
