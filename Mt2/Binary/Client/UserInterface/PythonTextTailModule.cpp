...
PyObject * textTailShowItemsTextTail(PyObject * poSelf, PyObject * poArgs)
{
	CPythonTextTail::Instance().ShowItemsTextTail();
	return Py_BuildNone();
}
#endif
...
#ifdef ITEM_TEXTAIL_OPTION
		{ "ShowItemsTextTail",			textTailShowItemsTextTail,			METH_VARARGS },
#endif
