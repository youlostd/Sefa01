...
long SHOP_SHOW_RANGE = 1500;

float CPythonConfig__GetOptionFloat(const std::string& stKey, float fDefaultValue);
PyObject * backgroundRefreshShopRange(PyObject * poSelf, PyObject * poArgs)
{
	SHOP_SHOW_RANGE = (long)CPythonConfig__GetOptionFloat("perf_shop_range", 1500.0f);
	return Py_BuildNone();
}
#endif
...
PyObject * backgroundSetForceRefreshTree(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground::Instance().GetMapOutdoorRef().SetForceRefreshTree();
	return Py_BuildNone();
}
#endif

#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
PyObject * backgroundSetForceGravelHide(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground::Instance().GetMapOutdoorRef().SetForceGravelHide();
	return Py_BuildNone();
}

PyObject * backgroundResetForceGravelHide(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground::Instance().GetMapOutdoorRef().ResetForceGravelHide();
	return Py_BuildNone();
}

PyObject * backgroundIsForceGravelHide(PyObject * poSelf, PyObject * poArgs)
{
	bool bIsHide = CPythonBackground::Instance().GetMapOutdoorRef().IsForceGravelHide();
	return Py_BuildValue("b", bIsHide);
}

PyObject * backgroundSetForceRefreshGravel(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground::Instance().GetMapOutdoorRef().SetForceRefreshGravel();
	return Py_BuildNone();
}
#endif
...
#ifdef ENABLE_TREE_HIDE_SYSTEM
		{ "SetForceRefreshTree",				backgroundSetForceRefreshTree,				METH_VARARGS },
#endif

#ifdef ENABLE_GRAVEL_HIDE_SYSTEM
		{ "SetForceGravelHide",					backgroundSetForceGravelHide,				METH_VARARGS },
		{ "ResetForceGravelHide",				backgroundResetForceGravelHide,				METH_VARARGS },
		{ "IsForceGravelHide",					backgroundIsForceGravelHide,				METH_VARARGS },
		{ "SetForceRefreshGravel",				backgroundSetForceRefreshGravel,			METH_VARARGS },
#endif
#ifdef ENABLE_SHOP_RANGE
		{ "RefreshShopRange",					backgroundRefreshShopRange,					METH_VARARGS },
#endif
