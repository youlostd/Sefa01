...
namespace
{
    ...
    public:
        ...
        double DoEvaluate()
        {
			...
			{
				static double seed = time(NULL);
				seedRef = &seed;
			}

			return NextRandom(seedRef) * (b - a) + a;
        }
    };
    ...
    public:
        ...
        double DoEvaluate()
        {
            return (m_nodes[0]->Evaluate() * 180.0) / EXPREVAL_PI;
        }
    };
    ...
    public:
        ...
        double DoEvaluate()
        {
            return (m_nodes[0]->Evaluate() * EXPREVAL_PI) / 180.0;
        }
    };
