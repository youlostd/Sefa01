...
{
	std::string stAtlasInfoFileName(CLocaleManager::instance().GetLocalePath());
...
void CPythonBackground::Warp(DWORD dwX, DWORD dwY)
{
	...
	GetMapOutdoorRef().SetBaseXY(m_dwBaseX, m_dwBaseY);
	CPythonMiniMap::Instance().LoadAtlasData();
