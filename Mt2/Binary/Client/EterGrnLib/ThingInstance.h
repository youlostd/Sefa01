...
class CGraphicThingInstance : public CGraphicObjectInstance
{
	...
	public:
		...
		static void	RegisterMotionThing(DWORD motionID, DWORD dwMotionKey, CGraphicThing * pMotionThing);
		...
		void		ShowManual() { m_bShowManual = true; }
		void		HideManual() { m_bShowManual = false; }
		bool		IsShowManual() const { return m_bShowManual; }
#endif
	...
	public:
		...
		void			SetMotionID(DWORD motionID) { m_dwMotionID = motionID; }
		DWORD			GetMotionID() { return m_dwMotionID; }
	...
	protected:
		...
		static std::unordered_map<DWORD, std::map<DWORD, CGraphicThing::TRef *>>	m_roMotionThingMap;
		DWORD									m_dwMotionID;
