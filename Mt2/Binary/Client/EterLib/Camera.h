...
typedef std::map<size_t, CCamera *> TCameraMap;
...
class CCameraManager : public CSingleton<CCameraManager>
{
	public:
		...
		bool AddCamera(size_t ucCameraNum);
		bool RemoveCamera(size_t ucCameraNum);

		CCamera * GetCurrentCamera();
		void SetCurrentCamera(size_t ucCameraNum);
		void ResetToPreviousCamera();

		bool isCurrentCamera(size_t ucCameraNum);

		size_t GetCurrentCameraNum();
