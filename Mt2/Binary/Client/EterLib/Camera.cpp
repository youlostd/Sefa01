...
void CCameraManager::SetCurrentCamera(size_t ucCameraNum)
{
...
bool CCameraManager::isCurrentCamera(size_t ucCameraNum)
{
...
// 잡스러운 함수들...
bool CCameraManager::AddCamera(size_t ucCameraNum)
{
...
bool CCameraManager::RemoveCamera(size_t ucCameraNum)
{
...
size_t CCameraManager::GetCurrentCameraNum()
{
	if (!m_pCurrentCamera)
